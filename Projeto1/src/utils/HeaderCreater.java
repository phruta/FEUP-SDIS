...
public class HeaderCreater extends MessageType {
	...
	public static byte[] stored(String fileId, String chunkNo) {
		String Header = STORED + SPACE + Peer.version + SPACE + Peer.peerID + SPACE + fileId + SPACE + chunkNo + SPACE
				+ CRLF + CRLF;
	...
	public static byte[] getChunk(String fileId, int chunkNo) {
		String Header = GETCHUNK + SPACE + Peer.version + SPACE + Peer.peerID + SPACE + fileId + SPACE + chunkNo + SPACE
				+ CRLF + CRLF;
